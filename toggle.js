const youtubeCss = `
#secondary-inner, #info, #masthead-container, #chat, #related, #description, #comments, #comment-teaser, .ytp-progress-bar-container, .ytp-time-display, ytd-thumbnail-overlay-time-status-renderer {
